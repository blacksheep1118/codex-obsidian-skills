...
| Web source collection | URLs, local HTML files | `web-course-notes-for-obsidian` uses the Python standard library for page titles, descriptions, learning-resource link discovery, and platform-aware `file://` path handling. |
